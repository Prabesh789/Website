// presentation/utils/extensions/theme.dart
import 'package:flutter/material.dart';
import 'package:portfolio_web/presentation/configs/const_colors.dart';
import 'package:portfolio_web/presentation/configs/const_sizes.dart';
...
extension ThemeEx on BuildContext {
  ThemeData theme() {
    return ThemeData(
      ...
      textTheme: textTheme().apply(bodyColor: kBlack, displayColor: kBlack),
  ...
  TextStyle get titleLarge => const TextStyle(fontSize: s42, fontWeight: bold);
  TextStyle get titleMedium => const TextStyle(fontSize: s38, fontWeight: bold);
  TextStyle get titleSmall => const TextStyle(fontSize: s32, fontWeight: bold);
  TextStyle get labelLarge => const TextStyle(fontSize: s26, fontWeight: bold);
  TextStyle get bodyLarge => const TextStyle(fontSize: s18, fontWeight: medium);
